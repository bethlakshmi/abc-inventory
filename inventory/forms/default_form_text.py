item_image_help = {
    'current_images': '''This is the list of all images in the sytem.  Images
     that are currently linked with this item are highlighted in blue.  To add
     or remove the link between the image and the item click the image
     thumbnail.Unlinking an image from this item will NOT delete the image
     from the system.''',
