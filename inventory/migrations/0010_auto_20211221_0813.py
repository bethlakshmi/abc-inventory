    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shows', models.ManyToManyField(blank=True, max_length=128, to='inventory.Show')),
            ],
            options={
                'ordering': ['title'],
            },
        ...
        migrations.AddField(
            model_name='item',
            name='colors',
            field=models.ManyToManyField(blank=True, max_length=128, to='inventory.Color'),
        ),
        migrations.AddField(
            model_name='item',
            name='performers',
        ...
        migrations.AddField(
            model_name='item',
            name='shows',
            field=models.ManyToManyField(blank=True, max_length=128, to='inventory.Show'),
        ),
        migrations.AddField(
            model_name='subitem',
            name='performers',
